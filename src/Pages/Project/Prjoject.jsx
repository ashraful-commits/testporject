    ...
    <div className="min-w-[1340px] rounded-[15px] pl-[48px]  pt-[30px] bg-[#FFF] min-h-[1140px] h-[1140px] grid grid-flow-row overflow-hidden">
      ...
      <div className="main-container flex min-w-full gap-[43px] w-[1300px] mt-[52px] tracking-[-.52px] h-[1072px] ">
        <div className="left w-[938px] h-full">
          ...
          <div className="projectDatials rounded-[8px] border w-full mt-[18px] h-[150px] px-[20px] py-[15px]">
          ...
          <div className="teamMember rounded-[8px] border w-full mt-[18px] h-[217px] px-[16px] py-[15px]">
            <div className="flex justify-between">
              {" "}
              <h1 className="text-[#230B34] font-[500] text-[20px] tracking-[.4px] font-['work_sans'] ">
                Team
            ...
            <div className="grid grid-cols-4 mt-5">
              <Team avatar={user} name="Makenna Bator" title="Sales person" />
              <Team avatar={user} name="Makenna Bator" title="Sales person" />
              <Team avatar={user} name="Makenna Bator" title="Sales person" />
              <Team avatar={user} name="Makenna Bator" title="Sales person" />
              <Team avatar={user} name="Makenna Bator" title="Sales person" />
          ...
          <div className="softweretools rounded-[8px] border w-full mt-[18px] h-[117px] px-[20px] py-[18px]">
            <div className="flex justify-between">
              {" "}
              <h1 className="text-[#230B34] font-[500] text-[20px] tracking-[.4px] font-['work_sans'] ">
                Software & Tools
            ...
            <div className="flex gap-[15px] mt-5">
              ...
              />
              <div className="flex  items-center  rounded-2xlw-[87px] h-[31px] gap-[10px]">
          ...
          <div className="ProjectFiles rounded-[8px] border w-full mt-[18px] h-[230px] px-[22px] py-[11px]">
            <div className="flex justify-between">
              {" "}
            ...
            <div className="grid gap-[15px] grid-cols-4 mt-5">
              ...
              <div className="flex  items-center  rounded-2xl w-[150px] h-[57px] gap-[10px]">
                <label
                  htmlFor=""
        ...
        <div className="right border w-[315px] rounded-[8px] mt-1 flex justify-center">
          <div className=" w-full h-full flex flex-col items-center">
            ...
            <div className="label w-full mt-4 px-[21px] text-[14px] font-[500] font-['work_sans'] text-[#230B34]">
              ...
              <div className="mt-2 flex  justify-start flex-wrap gap-[10px]">
            ...
            <div className="invoice w-full mt-4 px-[21px] text-[14px] font-[500] font-['work_sans'] text-[#230B34]">
              <label
                className="text-[14px] font-[500] font-['work_sans']"
                htmlFor=""
              >
              ...
              <div className="mt-2 flex flex-col justify-start flex-wrap gap-[10px]">
                <Invoices />
                <Invoices />
                <Invoices />
              </div>
            </div>
            <div className="comments  w-full mt-[56px] px-[21px] text-[14px] font-[500] font-['work_sans'] text-[#230B34]">
              <label
                className="text-[14px] font-[500] font-['work_sans']"
                htmlFor=""
              >
              ...
              <div className="mt-2 flex flex-col justify-start border h-[270px] rounded-md flex-wrap gap-[10px]"></div>
            </div>
          </div>
        </div>
      </div>
