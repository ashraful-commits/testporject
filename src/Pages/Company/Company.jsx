...
const Company = () => {
  ...
  //=========================================== TODO:redux data
  const { error, message, company } = useSelector(getAllCompanyState);
              ...
              return (
                ...
                >
                  ...
                  {loginInSeller.role === "super_admin" && (
                    <div className=" w-8 flex items-center justify-center mt-1 h-8 border p-1 rounded-md mb-auto">
                      <input onClick={handleCompanyStatus} type="checkbox" />
                    </div>
                  )}
                </div>
              );
