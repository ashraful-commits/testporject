...
const CompanyView = () => {
  ...
  return (
    <div>
      ...
      <div>
        <section className="relative mt-5 text-gray-600 bg-white body-font">
          <div className="container flex flex-wrap px-5 py-24 mx-auto sm:flex-nowrap">
            <div className="relative flex items-end justify-start p-10 overflow-hidden bg-white rounded-lg lg:w-2/3 md:w-1/2 sm:mr-10">
              <iframe
                width="100%"
                height="100%"
            ...
            <div className="flex flex-col w-full px-5 mt-8 bg-white rounded-md lg:w-1/3 md:w-1/2 md:ml-auto md:py-8 md:mt-0">
