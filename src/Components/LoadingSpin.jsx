const LoadingSpinner = () => {
  return (
    <div className="flex h-full justify-center items-center relative z-0 w-full ">
      <svg
        version="1.1"
        id="Layer_1"
      ...
      >
        <path
          style={{ fill: "#2D50A7" }}
          d="M244.364,372.364c-12.853,0-23.273,10.42-23.273,23.273v93.091c0,12.853,10.42,23.273,23.273,23.273
        c12.853,0,23.273-10.42,23.273-23.273v-93.091C267.636,382.784,257.216,372.364,244.364,372.364z"
        />
        <path
          style={{ fill: "#73A1FB" }}
          d="M244.364,0c-12.853,0-23.273,10.42-23.273,23.273v93.091c0,12.853,10.42,23.273,23.273,23.273
        c12.853,0,23.273-10.42,23.273-23.273V23.273C267.636,10.42,257.216,0,244.364,0z"
        />
        <path
          style={{ fill: "#355EC9" }}
          d="M359.557,338.281c-9.087-9.089-23.824-9.089-32.912,0c-9.089,9.087-9.089,23.824,0,32.912
        ...
        <g>
          <path
            style={{ fill: "#C4D9FD" }}
            d="M81.455,232.727H34.909c-12.853,0-23.273,10.42-23.273,23.273c0,12.853,10.42,23.273,23.273,23.273
          h46.545c12.853,0,23.273-10.42,23.273-23.273C104.727,243.147,94.307,232.727,81.455,232.727z"
          />
          <path
            style={{ fill: "#C4D9FD" }}
            d="M96.256,74.982c-9.087-9.089-23.824-9.089-32.912,0s-9.089,23.825,0,32.912l65.826,65.825
        ...
        <path
          style={{ fill: "#3D6DEB" }}
          d="M477.091,232.727H384c-12.853,0-23.273,10.42-23.273,23.273c0,12.853,10.42,23.273,23.273,23.273
        h93.091c12.853,0,23.273-10.42,23.273-23.273C500.364,243.147,489.944,232.727,477.091,232.727z"
        />
        <path
          style={{ fill: "#5286FA" }}
          d="M392.471,74.982l-65.826,65.825c-9.089,9.087-9.089,23.824,0,32.912
