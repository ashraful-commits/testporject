          ...
          ?.map((item, index) => {
            return (
              ...
              >
                    ...
                    <button>
                      <select
                        className={` focus:outline-none  ${
                          ...
                          "text-[#FFF] border-[.0187rem] bg-[#a7ff74] rounded-[2.8125rem] text-2xs  h-[1.425rem] w-[3.75rem]   "
                        }  `}
                        name="projectType"
                        id=""
                        value={item?.role}
                ...
                <td className="  relative z-0 text-sm  flex items-center justify-end gap-2 truncate text-center pr-4 font-[400] w-[50px] h-full text-shipGrey ">
                  <button
