...
const ProjectFile = ({ svg, name, title, file }) => {
  ...
  return (
    <div className="flex gap-[14px] relative h-[57px] relative w-[214px] items-center justify-start pl-[20px] mb-[2px] border rounded-md">
      <div className="download absolute top-0 left-5">
      ...
      <button
        ...
        className=" justify-self-end absolute right-3"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="3"
